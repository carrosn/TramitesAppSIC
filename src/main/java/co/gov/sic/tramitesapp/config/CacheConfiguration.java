package co.gov.sic.tramitesapp.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, co.gov.sic.tramitesapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, co.gov.sic.tramitesapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
