...
/**
 * REST controller for managing {@link co.gov.sic.tramitesapp.domain.Usuarios}.
 */
@RestController
@RequestMapping("/api")
public class UsuariosResource {
     ...
     */
    @GetMapping("/usuarios")
    public ResponseEntity<List<Usuarios>> getAllUsuarios(UsuariosCriteria criteria) {
        log.debug("REST request to get Usuarios by criteria: {}", criteria);
        List<Usuarios> entityList = usuariosQueryService.findByCriteria(criteria);
