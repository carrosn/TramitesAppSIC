...
export class EncuestaComponent implements OnInit, OnDestroy {
  ...
  loadAll(): void {
    this.encuestaService
      ...
      .subscribe((res: HttpResponse<IEncuesta[]>) => this.paginateEncuestas(res.body, res.headers));
  }
  ...
  ngOnInit(): void {
    this.loadAll();
    this.registerChangeInEncuestas();
  }
  ...
  registerChangeInEncuestas(): void {
    this.eventSubscriber = this.eventManager.subscribe('encuestaListModification', () => this.reset());
  }
