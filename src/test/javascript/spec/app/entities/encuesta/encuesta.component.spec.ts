...
import { EncuestaComponent } from 'app/entities/encuesta/encuesta.component';
...
describe('Component Tests', () => {
  describe('Encuesta Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.encuestas && comp.encuestas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
