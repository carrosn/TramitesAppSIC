...
import { TramitesComponent } from 'app/entities/tramites/tramites.component';
...
describe('Component Tests', () => {
  describe('Tramites Management Component', () => {
    let comp: TramitesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TramitesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.tramites && comp.tramites[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
