...
import co.gov.sic.tramitesapp.config.Constants;
import co.gov.sic.tramitesapp.domain.User;
import co.gov.sic.tramitesapp.repository.AuthorityRepository;
import co.gov.sic.tramitesapp.repository.UserRepository;
import co.gov.sic.tramitesapp.security.AuthoritiesConstants;
import co.gov.sic.tramitesapp.service.UserService;
import co.gov.sic.tramitesapp.service.dto.PasswordChangeDTO;
import co.gov.sic.tramitesapp.service.dto.UserDTO;
import co.gov.sic.tramitesapp.web.rest.vm.KeyAndPasswordVM;
import co.gov.sic.tramitesapp.web.rest.vm.ManagedUserVM;
...
import static co.gov.sic.tramitesapp.web.rest.AccountResourceIT.TEST_USER_LOGIN;
